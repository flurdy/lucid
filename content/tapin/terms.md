...
date: 2026-02-24
lastmod: 2026-02-24
description: "TapIn Terms of Service"
---

## Introduction

These Terms of Service ("Terms") govern your use of the TapIn mobile application ("the App"). By using the App, you agree to these Terms.

## Use of the App

TapIn is a quick-message app for sending pre-written messages to your favorite contacts. You may use the App for lawful personal purposes only.

You agree not to:

- Use the App to send spam, harassment, or unsolicited messages
